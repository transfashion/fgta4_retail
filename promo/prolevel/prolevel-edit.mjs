...
import * as hnd from  './prolevel-edit-hnd.mjs'
...
const obj = {
	txt_prolevel_id: $('#pnl_edit-txt_prolevel_id'),
	txt_prolevel_name: $('#pnl_edit-txt_prolevel_name'),
	txt_prolevel_descr: $('#pnl_edit-txt_prolevel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_prolevel_id,
		autoid: false,
		logview: 'mst_prolevel',
