...
if (is_file(__DIR__ .'/prolevel.php-handler.php')) {
	require_once __DIR__ .'/prolevel.php-handler.php';
}

/**
 * retail/promo/prolevel/prolevel.php
 *
 * ===================================================================
 * Entry point Program Module prolevel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prolevel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prolevel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
