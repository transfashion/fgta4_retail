...
import * as hnd from  './progrouping-edit-hnd.mjs'
...
const obj = {
	txt_progrouping_id: $('#pnl_edit-txt_progrouping_id'),
	txt_progrouping_name: $('#pnl_edit-txt_progrouping_name'),
	txt_progrouping_descr: $('#pnl_edit-txt_progrouping_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_progrouping_id,
		autoid: false,
		logview: 'mst_progrouping',
...
function form_idsetup(options) {
	var objid = obj.txt_progrouping_id
