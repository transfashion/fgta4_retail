...
if (is_file(__DIR__ .'/progrouping.php-handler.php')) {
	require_once __DIR__ .'/progrouping.php-handler.php';
}

/**
 * retail/promo/progrouping/progrouping.php
 *
 * ===================================================================
 * Entry point Program Module progrouping
 * ===================================================================
 ...
 * awal dibuat tanggal 05/04/2023
 * terakhir di generate tanggal 05/04/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\progrouping_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new progrouping_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
