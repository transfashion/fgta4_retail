...
import * as hnd from  './problock-edit-hnd.mjs'
...
const obj = {
	txt_problock_id: $('#pnl_edit-txt_problock_id'),
	txt_problock_name: $('#pnl_edit-txt_problock_name'),
	txt_problock_descr: $('#pnl_edit-txt_problock_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_problock_id,
		autoid: false,
		logview: 'mst_problock',
