...
if (is_file(__DIR__ .'/problock.php-handler.php')) {
	require_once __DIR__ .'/problock.php-handler.php';
}

/**
 * retail/promo/problock/problock.php
 *
 * ===================================================================
 * Entry point Program Module problock
 * ===================================================================
 ...
 * awal dibuat tanggal 01/04/2023
 * terakhir di generate tanggal 01/04/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\problock_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new problock_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
