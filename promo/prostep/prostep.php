...
if (is_file(__DIR__ .'/prostep.php-handler.php')) {
	require_once __DIR__ .'/prostep.php-handler.php';
}

/**
 * retail/promo/prostep/prostep.php
 *
 * ===================================================================
 * Entry point Program Module prostep
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prostep_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prostep_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
