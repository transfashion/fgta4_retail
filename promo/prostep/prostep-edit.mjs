...
import * as hnd from  './prostep-edit-hnd.mjs'
...
const obj = {
	txt_prostep_id: $('#pnl_edit-txt_prostep_id'),
	txt_prostep_name: $('#pnl_edit-txt_prostep_name'),
	txt_prostep_descr: $('#pnl_edit-txt_prostep_descr')
}
