...
import * as hnd from  './proprog-siteform-hnd.mjs'
...
const obj = {
	txt_prosite_id: $('#pnl_editsiteform-txt_prosite_id'),
	cbo_site_id: $('#pnl_editsiteform-cbo_site_id'),
	txt_proprog_id: $('#pnl_editsiteform-txt_proprog_id')
}
