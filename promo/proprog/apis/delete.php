...
/**
 * retail/promo/proprog/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header proprog (mst_proprog)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_proprogitemstocka', 'mst_proprogitemstockb', 'mst_prosite', 'mst_propaymethod'];
