...
if (is_file(__DIR__ .'/proprog.php-handler.php')) {
	require_once __DIR__ .'/proprog.php-handler.php';
}

/**
 * retail/promo/proprog/proprog.php
 *
 * ===================================================================
 * Entry point Program Module proprog
 * ===================================================================
 ...
 * awal dibuat tanggal 31/03/2023
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\proprog_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new proprog_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
