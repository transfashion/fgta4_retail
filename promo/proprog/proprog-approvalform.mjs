...
const obj = {
	txt_proprogappr_id: $('#pnl_editapprovalform-txt_proprogappr_id'),
	chk_proprogappr_isapproved: $('#pnl_editapprovalform-chk_proprogappr_isapproved'),
	txt_proprogappr_by: $('#pnl_editapprovalform-txt_proprogappr_by'),
	txt_proprogappr_date: $('#pnl_editapprovalform-txt_proprogappr_date'),
	txt_proprog_version: $('#pnl_editapprovalform-txt_proprog_version'),
	chk_proprogappr_isdeclined: $('#pnl_editapprovalform-chk_proprogappr_isdeclined'),
	txt_proprogappr_declinedby: $('#pnl_editapprovalform-txt_proprogappr_declinedby'),
	txt_proprogappr_declineddate: $('#pnl_editapprovalform-txt_proprogappr_declineddate'),
	txt_proprogappr_notes: $('#pnl_editapprovalform-txt_proprogappr_notes'),
	txt_proprog_id: $('#pnl_editapprovalform-txt_proprog_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_proprogappr_id,
		autoid: true,
		logview: 'mst_proprogappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.proprog_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_proprogappr_id
