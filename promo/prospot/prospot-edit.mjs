...
import * as hnd from  './prospot-edit-hnd.mjs'
...
const obj = {
	txt_prospot_id: $('#pnl_edit-txt_prospot_id'),
	txt_prospot_name: $('#pnl_edit-txt_prospot_name'),
	txt_prospot_descr: $('#pnl_edit-txt_prospot_descr')
}
