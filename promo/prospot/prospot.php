...
if (is_file(__DIR__ .'/prospot.php-handler.php')) {
	require_once __DIR__ .'/prospot.php-handler.php';
}

/**
 * retail/promo/prospot/prospot.php
 *
 * ===================================================================
 * Entry point Program Module prospot
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prospot_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prospot_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
