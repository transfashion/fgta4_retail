...
if (is_file(__DIR__ .'/prorule.php-handler.php')) {
	require_once __DIR__ .'/prorule.php-handler.php';
}

/**
 * retail/promo/prorule/prorule.php
 *
 * ===================================================================
 * Entry point Program Module prorule
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\prorule_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new prorule_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
