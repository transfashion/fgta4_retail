...
/**
 * retail/promo/prorule/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends proruleBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->prorule_id = strtoupper($obj->prorule_id);
			$obj->prorule_name = strtoupper($obj->prorule_name);


			if ($obj->prorule_lib=='') { $obj->prorule_lib = '--NULL--'; }
