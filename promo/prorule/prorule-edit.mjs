...
import * as hnd from  './prorule-edit-hnd.mjs'
...
const obj = {
	txt_prorule_id: $('#pnl_edit-txt_prorule_id'),
	cbo_prolevel_id: $('#pnl_edit-cbo_prolevel_id'),
	cbo_problock_id: $('#pnl_edit-cbo_problock_id'),
	txt_prorule_name: $('#pnl_edit-txt_prorule_name'),
	txt_prorule_descr: $('#pnl_edit-txt_prorule_descr'),
	txt_prorule_lib: $('#pnl_edit-txt_prorule_lib'),
	...
	new fgta4slideselect(obj.cbo_prolevel_id, {
		...
		OnSelected: (value, display, record, args) => {
			if (value!=args.PreviousValue ) {
				if (typeof hnd.cbo_prolevel_id_selected === 'function') {
					hnd.cbo_prolevel_id_selected(value, display, record, args);
				}
			}
		},
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['a_prospot_id', ];
