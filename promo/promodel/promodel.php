...
if (is_file(__DIR__ .'/promodel.php-handler.php')) {
	require_once __DIR__ .'/promodel.php-handler.php';
}

/**
 * retail/promo/promodel/promodel.php
 *
 * ===================================================================
 * Entry point Program Module promodel
 * ===================================================================
 ...
 * awal dibuat tanggal 29/03/2023
 * terakhir di generate tanggal 31/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
