...
/**
 * retail/pos/posterminal/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header posterminal (mst_posterminal)
...
$API = new class extends posterminalBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.posterminal_id LIKE CONCAT('%', :search, '%') OR A.site_id LIKE CONCAT('%', :search, '%') "
			];
