...
if (is_file(__DIR__ .'/posterminal.php-handler.php')) {
	require_once __DIR__ .'/posterminal.php-handler.php';
}

/**
 * retail/pos/posterminal/posterminal.php
 *
 * ===================================================================
 * Entry point Program Module posterminal
 * ===================================================================
 ...
 * awal dibuat tanggal 31/01/2023
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\posterminal_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new posterminal_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
