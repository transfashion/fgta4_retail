...
import * as hnd from  './positem-edit-hnd.mjs'
...
const obj = {
	txt_positemstock_id: $('#pnl_edit-txt_positemstock_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_positemstock_id,
		autoid: true,
		logview: 'pos_itemstock',
...
function form_idsetup(options) {
	var objid = obj.txt_positemstock_id
