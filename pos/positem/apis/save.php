...
/**
 * retail/pos/positem/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends positemBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->itemgroup_id=='') { $obj->itemgroup_id = '--NULL--'; }
			if ($obj->itemgroup_name=='') { $obj->itemgroup_name = '--NULL--'; }
			if ($obj->itemctg_id=='') { $obj->itemctg_id = '--NULL--'; }
			if ($obj->itemctg_name=='') { $obj->itemctg_name = '--NULL--'; }
			if ($obj->itemclass_id=='') { $obj->itemclass_id = '--NULL--'; }
			if ($obj->itemclass_name=='') { $obj->itemclass_name = '--NULL--'; }
			...
			try {
				...
				// result
				$options->criteria = [
					"positemstock_id" => $obj->positemstock_id
				];
