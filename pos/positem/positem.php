...
if (is_file(__DIR__ .'/positem.php-handler.php')) {
	require_once __DIR__ .'/positem.php-handler.php';
}

/**
 * retail/pos/positem/positem.php
 *
 * ===================================================================
 * Entry point Program Module positem
 * ===================================================================
 ...
 * awal dibuat tanggal 01/03/2023
 * terakhir di generate tanggal 02/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\positem_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new positem_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
