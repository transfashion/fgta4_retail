...
import * as hnd from  './positem-barcodeform-hnd.mjs'
...
const obj = {
	txt_positemstockbarcode_id: $('#pnl_editbarcodeform-txt_positemstockbarcode_id'),
	txt_site_id: $('#pnl_editbarcodeform-txt_site_id'),
	...
	txt_dept_id: $('#pnl_editbarcodeform-txt_dept_id'),
	chk_itemstockbarcode_isupdating: $('#pnl_editbarcodeform-chk_itemstockbarcode_isupdating'),
	chk_itemstockbarcode_isinternal: $('#pnl_editbarcodeform-chk_itemstockbarcode_isinternal'),
	txt_positemstock_id: $('#pnl_editbarcodeform-txt_positemstock_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_positemstockbarcode_id,
		autoid: true,
		logview: 'pos_itemstockbarcode',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.positemstock_id= hdata.positemstock_id
...
function form_idsetup(options) {
	var objid = obj.txt_positemstockbarcode_id
