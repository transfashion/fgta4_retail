...
import * as hnd from  './pospaytype-edit-hnd.mjs'
...
const obj = {
	txt_paytype_id: $('#pnl_edit-txt_paytype_id'),
	txt_paytype_name: $('#pnl_edit-txt_paytype_name'),
