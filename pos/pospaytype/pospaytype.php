...
if (is_file(__DIR__ .'/pospaytype.php-handler.php')) {
	require_once __DIR__ .'/pospaytype.php-handler.php';
}

/**
 * retail/pos/pospaytype/pospaytype.php
 *
 * ===================================================================
 * Entry point Program Module pospaytype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\pospaytype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new pospaytype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
