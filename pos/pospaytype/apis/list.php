...
/**
 * retail/pos/pospaytype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header pospaytype (pos_paytype)
...
$API = new class extends pospaytypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.paytype_id LIKE CONCAT('%', :search, '%') OR A.paytype_name LIKE CONCAT('%', :search, '%') "
			];
