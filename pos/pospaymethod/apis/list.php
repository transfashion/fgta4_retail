...
/**
 * retail/pos/pospaymethod/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header pospaymethod (pos_paymethod)
...
$API = new class extends pospaymethodBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.paymethod_id LIKE CONCAT('%', :search, '%') OR A.site_id LIKE CONCAT('%', :search, '%') OR A.paymethod_name LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('paytype_name', 'paytype_id', $record, 'pos_paytype', 'paytype_name', 'paytype_id');
				$this->addFields('posterminal_code', 'posterminal_id', $record, 'mst_posterminal', 'posterminal_code', 'posterminal_id');
