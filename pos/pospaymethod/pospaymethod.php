...
if (is_file(__DIR__ .'/pospaymethod.php-handler.php')) {
	require_once __DIR__ .'/pospaymethod.php-handler.php';
}

/**
 * retail/pos/pospaymethod/pospaymethod.php
 *
 * ===================================================================
 * Entry point Program Module pospaymethod
 * ===================================================================
 ...
 * awal dibuat tanggal 06/03/2023
 * terakhir di generate tanggal 19/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\pospaymethod_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new pospaymethod_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
