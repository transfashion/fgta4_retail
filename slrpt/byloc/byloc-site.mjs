...
const tbl_list = $('#pnl_listsite-tbl_list')
const el_dtstart = $('#pnl_listsite-obj_date_start')
const el_dtend = $('#pnl_listsite-obj_date_end')
const obj_total_tx = $('#pnl_listsite-total_tx')
const obj_total_qty = $('#pnl_listsite-total_qty')
const obj_total_gross = $('#pnl_listsite-total_gross')
const obj_total_nett = $('#pnl_listsite-total_nett')
