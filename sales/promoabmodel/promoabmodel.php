...
if (is_file(__DIR__ .'/promoabmodel.php-handler.php')) {
	require_once __DIR__ .'/promoabmodel.php-handler.php';
}

/**
 * retail/sales/promoabmodel/promoabmodel.php
 *
 * ===================================================================
 * Entry point Program Module promoabmodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promoabmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promoabmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
