...
if (is_file(__DIR__ .'/promoabdiscstep.php-handler.php')) {
	require_once __DIR__ .'/promoabdiscstep.php-handler.php';
}

/**
 * retail/sales/promoabdiscstep/promoabdiscstep.php
 *
 * ===================================================================
 * Entry point Program Module promoabdiscstep
 * ===================================================================
 ...
 * awal dibuat tanggal 28/03/2023
 * terakhir di generate tanggal 28/03/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promoabdiscstep_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promoabdiscstep_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
