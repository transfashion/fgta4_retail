...
/**
 * retail/sales/promoabdiscstep/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header promoabdiscstep (mst_promoabdiscstep)
...
$API = new class extends promoabdiscstepBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.promoabdiscstep_id LIKE CONCAT('%', :search, '%') "
			];
