...
import * as hnd from  './promoabdiscstep-edit-hnd.mjs'
...
const obj = {
	txt_promoabdiscstep_id: $('#pnl_edit-txt_promoabdiscstep_id'),
	txt_promoabdiscstep_name: $('#pnl_edit-txt_promoabdiscstep_name'),
	txt_promoabdiscstep_descr: $('#pnl_edit-txt_promoabdiscstep_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_promoabdiscstep_id,
		autoid: false,
		logview: 'mst_promoabdiscstep',
...
function form_idsetup(options) {
	var objid = obj.txt_promoabdiscstep_id
