...
/**
 * retail/sales/merchorderin/apis/items-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel items merchorderin (trn_merchorderinitem)
 *
...
$API = new class extends merchorderinBase {
	...
	public function execute($data, $options) {
		$event = 'on-save';
		$tablename = 'trn_merchorderinitem';
		$primarykey = 'merchorderinitem_id';
		...
		try {
			...
			$sqlUpdateField  = [
					'merchorderinitem_id', 'merchitem_id', 'merchitem_art', 'merchitem_mat',
					'merchitem_col', 'merchitem_size', 'merchitem_name', 'merchorderinitem_qty',
					'merchorderinitem_valfrg', 'curr_id', 'merchorderinitem_valfrgrate', 'merchorderinitem_subvalfrg',
					'merchorderinitem_subvalidr', 'merchorderin_id'
			];
			...
			try {
				...
				$header_table = 'trn_merchorderin';
				$header_primarykey = 'merchorderin_id';
				$detil_primarykey = 'merchorderin_id';
				...
				// result
				$options->criteria = [
					"merchorderinitem_id" => $obj->merchorderinitem_id
				];

				$criteriaValues = [
					"merchorderinitem_id" => " merchorderinitem_id = :merchorderinitem_id "
				];
				...
				$sqlFieldList = [
					'merchorderinitem_id' => 'A.`merchorderinitem_id`', 'merchitem_id' => 'A.`merchitem_id`', 'merchitem_art' => 'A.`merchitem_art`', 'merchitem_mat' => 'A.`merchitem_mat`',
					'merchitem_col' => 'A.`merchitem_col`', 'merchitem_size' => 'A.`merchitem_size`', 'merchitem_name' => 'A.`merchitem_name`', 'merchorderinitem_qty' => 'A.`merchorderinitem_qty`',
					'merchorderinitem_valfrg' => 'A.`merchorderinitem_valfrg`', 'curr_id' => 'A.`curr_id`', 'merchorderinitem_valfrgrate' => 'A.`merchorderinitem_valfrgrate`', 'merchorderinitem_subvalfrg' => 'A.`merchorderinitem_subvalfrg`',
					'merchorderinitem_subvalidr' => 'A.`merchorderinitem_subvalidr`', 'merchorderin_id' => 'A.`merchorderin_id`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "trn_merchorderinitem A";
				$sqlWhere = $where->sql;
