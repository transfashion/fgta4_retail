		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('merchorderin_commitby', 'merchorderin_commitby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');
				$this->addFields('merchorderin_postby', 'merchorderin_postby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');
