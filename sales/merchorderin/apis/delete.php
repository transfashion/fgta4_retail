...
/**
 * retail/sales/merchorderin/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header merchorderin (trn_merchorderin)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['trn_merchorderinitem', 'trn_merchorderin', 'trn_merchorderin'];
