...
if (is_file(__DIR__ .'/merchorderin.php-handler.php')) {
	require_once __DIR__ .'/merchorderin.php-handler.php';
}

/**
 * retail/sales/merchorderin/merchorderin.php
 *
 * ===================================================================
 * Entry point Program Module merchorderin
 * ===================================================================
 ...
 * awal dibuat tanggal 19/09/2023
 * terakhir di generate tanggal 20/09/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchorderin_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchorderin_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
