...
import * as hnd from  './merchorderin-itemsform-hnd.mjs'
...
const obj = {
	txt_merchorderinitem_id: $('#pnl_edititemsform-txt_merchorderinitem_id'),
	...
	txt_merchorderinitem_qty: $('#pnl_edititemsform-txt_merchorderinitem_qty'),
	txt_merchorderinitem_valfrg: $('#pnl_edititemsform-txt_merchorderinitem_valfrg'),
	cbo_curr_id: $('#pnl_edititemsform-cbo_curr_id'),
	txt_merchorderinitem_valfrgrate: $('#pnl_edititemsform-txt_merchorderinitem_valfrgrate'),
	txt_merchorderinitem_subvalfrg: $('#pnl_edititemsform-txt_merchorderinitem_subvalfrg'),
	txt_merchorderinitem_subvalidr: $('#pnl_edititemsform-txt_merchorderinitem_subvalidr'),
	txt_merchorderin_id: $('#pnl_edititemsform-txt_merchorderin_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchorderinitem_id,
		autoid: true,
		logview: 'trn_merchorderinitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.merchorderin_descr)
	if (typeof hnd!=='undefined') { 
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.merchorderin_id = hdata.merchorderin_id
		data.items_value = 0

		data.merchorderinitem_qty = 0
		data.merchorderinitem_valfrg = 0
		data.merchorderinitem_valfrgrate = 0
		data.merchorderinitem_subvalfrg = 0
		data.merchorderinitem_subvalidr = 0
...
function form_idsetup(options) {
	var objid = obj.txt_merchorderinitem_id
