...
$API = new class extends promoabBase {
		...
		try {
			...
			$data = (object)[
				...
				"groupA" => [
					...
					"fixPrice" => $row['promoab_a_fixprice'],
				...
				"groupB" => [
					...
					"fixPrice" => $row['promoab_b_fixprice'],
	...
	public function getItemPricing(string $str_price_ids) : array {
		try {
			$sql = "
			...
			$items = [];
			$arr_price_ids = explode(';', $str_price_ids);
			foreach ($arr_price_ids as $price_id) {
