...
import * as hnd from  './promoab-siteform-hnd.mjs'
...
const obj = {
	txt_promoabsite_id: $('#pnl_editsiteform-txt_promoabsite_id'),
	cbo_site_id: $('#pnl_editsiteform-cbo_site_id'),
	txt_site_code: $('#pnl_editsiteform-txt_site_code'),
	txt_promoab_id: $('#pnl_editsiteform-txt_promoab_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_promoabsite_id,
		autoid: true,
		logview: 'mst_promoabsite',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_promoabsite_id
