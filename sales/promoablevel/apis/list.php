...
/**
 * retail/sales/promoablevel/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header promoablevel (mst_promoablevel)
...
$API = new class extends promoablevelBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.promoablevel_id LIKE CONCAT('%', :search, '%') "
			];
