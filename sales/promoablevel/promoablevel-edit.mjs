...
import * as hnd from  './promoablevel-edit-hnd.mjs'
...
const obj = {
	txt_promoablevel_id: $('#pnl_edit-txt_promoablevel_id'),
	txt_promoablevel_name: $('#pnl_edit-txt_promoablevel_name'),
	txt_promoablevel_descr: $('#pnl_edit-txt_promoablevel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_promoablevel_id,
		autoid: false,
		logview: 'mst_promoablevel',
...
function form_idsetup(options) {
	var objid = obj.txt_promoablevel_id
