...
if (is_file(__DIR__ .'/promoablevel.php-handler.php')) {
	require_once __DIR__ .'/promoablevel.php-handler.php';
}

/**
 * retail/sales/promoablevel/promoablevel.php
 *
 * ===================================================================
 * Entry point Program Module promoablevel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promoablevel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promoablevel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
