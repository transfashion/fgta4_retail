...
import * as hnd from  './promoabdiscspot-edit-hnd.mjs'
...
const obj = {
	txt_promoabdiscspot_id: $('#pnl_edit-txt_promoabdiscspot_id'),
	txt_promoabdiscspot_name: $('#pnl_edit-txt_promoabdiscspot_name'),
	txt_promoabdiscspot_descr: $('#pnl_edit-txt_promoabdiscspot_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_promoabdiscspot_id,
		autoid: false,
		logview: 'mst_promoabdiscspot',
...
function form_idsetup(options) {
	var objid = obj.txt_promoabdiscspot_id
