...
/**
 * retail/sales/promoabdiscspot/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header promoabdiscspot (mst_promoabdiscspot)
...
$API = new class extends promoabdiscspotBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.promoabdiscspot_id LIKE CONCAT('%', :search, '%') "
			];
