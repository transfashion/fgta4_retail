...
if (is_file(__DIR__ .'/promoabdiscspot.php-handler.php')) {
	require_once __DIR__ .'/promoabdiscspot.php-handler.php';
}

/**
 * retail/sales/promoabdiscspot/promoabdiscspot.php
 *
 * ===================================================================
 * Entry point Program Module promoabdiscspot
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promoabdiscspot_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promoabdiscspot_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
