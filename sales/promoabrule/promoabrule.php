...
if (is_file(__DIR__ .'/promoabrule.php-handler.php')) {
	require_once __DIR__ .'/promoabrule.php-handler.php';
}

/**
 * retail/sales/promoabrule/promoabrule.php
 *
 * ===================================================================
 * Entry point Program Module promoabrule
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\promoabrule_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new promoabrule_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
