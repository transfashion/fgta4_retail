...
class PrintForm extends WebModule {
	function __construct() {
		// $logfilepath = __LOCALDB_DIR . "/output/logfile-merchorderout.txt";
	...
	public function LoadPage() {
		...
		try {
			...
			$this->merchorderout_id = $row['merchorderout_id'];
	...
	function getSqlHeader() {
		return "
			...
			from trn_merchorderout A where merchorderout_id = :merchorderout_id
		";
	}	
