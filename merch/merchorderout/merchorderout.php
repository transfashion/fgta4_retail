...
if (is_file(__DIR__ .'/merchorderout.php-handler.php')) {
	require_once __DIR__ .'/merchorderout.php-handler.php';
}

/**
 * retail/merch/merchorderout/merchorderout.php
 *
 * ===================================================================
 * Entry point Program Module merchorderout
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchorderout_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchorderout_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
