...
import * as hnd from  './merchorderout-edit-hnd.mjs'
...
const obj = {
	txt_merchorderout_id: $('#pnl_edit-txt_merchorderout_id'),
	cbo_unit_id: $('#pnl_edit-cbo_unit_id'),
	txt_merchorderout_ref: $('#pnl_edit-txt_merchorderout_ref'),
	dt_merchorderout_date: $('#pnl_edit-dt_merchorderout_date'),
	txt_merchorderout_descr: $('#pnl_edit-txt_merchorderout_descr'),
	...
	txt_orderout_qty: $('#pnl_edit-txt_orderout_qty'),
	txt_orderout_totalvaluefrg: $('#pnl_edit-txt_orderout_totalvaluefrg'),
	txt_orderout_totalvalueidr: $('#pnl_edit-txt_orderout_totalvalueidr'),
	txt_orderout_outstdqty: $('#pnl_edit-txt_orderout_outstdqty'),
	txt_orderout_outstdvaluefrg: $('#pnl_edit-txt_orderout_outstdvaluefrg'),
	txt_orderout_outstdvalueidr: $('#pnl_edit-txt_orderout_outstdvalueidr'),
	txt_merchorderout_version: $('#pnl_edit-txt_merchorderout_version'),
	chk_merchorderout_iscommit: $('#pnl_edit-chk_merchorderout_iscommit'),
	txt_merchorderout_commitby: $('#pnl_edit-txt_merchorderout_commitby'),
	txt_merchorderout_commitdate: $('#pnl_edit-txt_merchorderout_commitdate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchorderout_id,
		autoid: true,
		logview: 'trn_merchorderout',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchorderout_date = global.now()
		data.curr_rate = 0
		data.orderout_qty = 0
		data.orderout_totalvaluefrg = 0
		data.orderout_totalvalueidr = 0
		data.orderout_outstdqty = 0
		data.orderout_outstdvaluefrg = 0
		data.orderout_outstdvalueidr = 0
		data.merchorderout_version = 0
		data.merchorderout_iscommit = '0'
		...
		$ui.getPages().ITEMS['pnl_editshipgrid'].handler.createnew(data, options)
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.merchorderout_commitby);
	rec_commitdate.html(record.merchorderout_commitdate);
...
function updatebuttonstate(record) {
	...
	if (record.merchorderout_iscommit=="1") {
...
function updategridstate(record) {
	...
	var col_commit = 'merchorderout_iscommit';
	updategriddata[col_commit] = record.merchorderout_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_merchorderout_id
...
function btn_print_click() {
	...
	var args = {
		...
		reportmodule: `${module}/merchorderout.xprint?renderto=${renderto}&format=${format}`,
		handled: false
	}
...
async function btn_action_click(args) {
	...
	var txt_version = obj.txt_merchorderout_version;
	var chk_iscommit = obj.chk_merchorderout_iscommit;
