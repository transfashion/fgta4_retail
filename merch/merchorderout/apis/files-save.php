...
/**
 * retail/merch/merchorderout/apis/files-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel files merchorderout (trn_orderoutfiles)
 *
...
$API = new class extends merchorderoutBase {
	...
	public function execute($data, $options, $files) {
		...
		$handlerclassname = "\\FGTA4\\apis\\merchorderout_filesHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchorderout_filesHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
