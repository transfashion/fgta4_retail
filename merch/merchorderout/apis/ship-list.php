...
/**
 * retail/merch/merchorderout/apis/ship-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel ship merchorderout (trn_merchship)
...
$API = new class extends merchorderoutBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new merchorderout_shipHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
