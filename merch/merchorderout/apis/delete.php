...
/**
 * retail/merch/merchorderout/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header merchorderout (trn_merchorderout)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['trn_merchorderoutitem', 'trn_merchship', 'trn_orderoutfiles', 'trn_merchorderout', 'trn_merchorderout'];
