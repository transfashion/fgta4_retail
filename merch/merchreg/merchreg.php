...
if (is_file(__DIR__ .'/merchreg.php-handler.php')) {
	require_once __DIR__ .'/merchreg.php-handler.php';
}

/**
 * retail/merch/merchreg/merchreg.php
 *
 * ===================================================================
 * Entry point Program Module merchreg
 * ===================================================================
 ...
 * awal dibuat tanggal 12/07/2023
 * terakhir di generate tanggal 01/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchreg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchreg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
