...
const obj = {
	...
	cbo_merchregtype_id: $('#pnl_edit-cbo_merchregtype_id'),
...
export async function init(opt) {
	...
	obj.cbo_merchregtype_id.name = 'pnl_edit-cbo_merchregtype_id'		
	new fgta4slideselect(obj.cbo_merchregtype_id, {
		title: 'Pilih merchregtype_id',
		returnpage: this_page_id,
		api: $ui.apis.load_merchregtype_id,
		fieldValue: 'merchregtype_id',
		fieldDisplay: 'merchregtype_name',
		fields: [
			{mapping: 'merchregtype_id', text: 'merchregtype_id'},
			{mapping: 'merchregtype_name', text: 'merchregtype_name'}
		],
	...
	var fn_dataopened = async (result, options) => {
		...
		*/
		...
		form
			...
			.setValue(obj.cbo_merchregtype_id, record.merchregtype_id, record.merchregtype_name)
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchregtype_id = '0'
		data.merchregtype_name = '-- PILIH --'
