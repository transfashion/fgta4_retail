...
module.exports = {
	...
	persistent: {
		'trn_merchreg' : {
			...
			data: {
				...
				merchregtype_id: { 
					text: 'Reg Type', type: dbtype.varchar(10), null: true,
					options: { required: true, invalidMessage: 'Register type harus diisi' }, 
					comp: comp.Combo({
						table: 'mst_merchregtype',
						field_value: 'merchregtype_id', field_display: 'merchregtype_name',
						api: 'retail/master/merchregtype/list'
					})
				},	
				...
				merchregtype_iscangenerate: { text: 'Can Generate', type: dbtype.boolean, null: false, default: '0' },
		...
		'trn_merchregitem' : {
			...
			data: {
				...
				merchitem_refcode: {text:'RefCode', type: dbtype.varchar(30), null:true, suppresslist: true},
				...
				merchitem_id: {
					text:'ItemId', type: dbtype.varchar(14), null:true, suppresslist: true,
					reference: {table: 'mst_itemstock', field_value: 'itemstock_id', field_display:'itemstock_name',  field_display_name:'itemstock_name'}, 
				},

				mercharticle_id: {
					text:'ArticleId', type: dbtype.varchar(14), null:true, suppresslist: true,
					reference: {table: 'mst_mercharticle', field_value: 'mercharticle_id', field_display:'mercharticle_name',  field_display_name:'mercharticle_name'}, 
				},
				...
				mercharticle_paircode: {text:'ArtMatPair', type: dbtype.varchar(30), suppresslist: true},
	...
	schema: {
		...
		detils: {
			'item': {
				title: 'Items', table: 'trn_merchregitem', form: true, headerview: 'merchreg_descr', 
