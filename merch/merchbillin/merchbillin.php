...
if (is_file(__DIR__ .'/merchbillin.php-handler.php')) {
	require_once __DIR__ .'/merchbillin.php-handler.php';
}

/**
 * retail/merch/merchbillin/merchbillin.php
 *
 * ===================================================================
 * Entry point Program Module merchbillin
 * ===================================================================
 ...
 * terakhir di generate tanggal 03/08/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchbillin_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchbillin_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
