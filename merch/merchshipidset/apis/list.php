...
/**
 * retail/merch/merchshipidset/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchshipidset (trn_merchshipidset)
...
$API = new class extends merchshipidsetBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.merchshipidset_id LIKE CONCAT('%', :search, '%') "
			];
