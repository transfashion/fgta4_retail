...
import * as hnd from  './merchshipidset-edit-hnd.mjs'
...
const obj = {
	txt_merchshipidset_id: $('#pnl_edit-txt_merchshipidset_id'),
	txt_merchship_id: $('#pnl_edit-txt_merchship_id'),
	txt_merchshipidset_doc: $('#pnl_edit-txt_merchshipidset_doc'),
	txt_merchshipidset_value: $('#pnl_edit-txt_merchshipidset_value')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchshipidset_id,
		autoid: true,
		logview: 'trn_merchshipidset',
...
function form_idsetup(options) {
	var objid = obj.txt_merchshipidset_id
...
async function btn_action_click(args) {
	...
	var txt_version = obj.txt_merchshipidset_version;
	var chk_iscommit = obj.chk_merchshipidset_iscommit;
