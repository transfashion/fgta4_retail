...
if (is_file(__DIR__ .'/merchshipidset.php-handler.php')) {
	require_once __DIR__ .'/merchshipidset.php-handler.php';
}

/**
 * retail/merch/merchshipidset/merchshipidset.php
 *
 * ===================================================================
 * Entry point Program Module merchshipidset
 * ===================================================================
 ...
 * awal dibuat tanggal 06/11/2023
 * terakhir di generate tanggal 06/11/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchshipidset_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchshipidset_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
