...
import * as hnd from  './merchship-recvform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editrecvform-caption')
...
const obj = {
	txt_merchrv_id: $('#pnl_editrecvform-txt_merchrv_id'),
	dt_merchrv_date: $('#pnl_editrecvform-dt_merchrv_date'),
	txt_merchrv_descr: $('#pnl_editrecvform-txt_merchrv_descr'),
	txt_merchship_id: $('#pnl_editrecvform-txt_merchship_id')
}
