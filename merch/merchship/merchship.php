...
if (is_file(__DIR__ .'/merchship.php-handler.php')) {
	require_once __DIR__ .'/merchship.php-handler.php';
}

/**
 * retail/merch/merchship/merchship.php
 *
 * ===================================================================
 * Entry point Program Module merchship
 * ===================================================================
 * shipment barang
 *
 * Create by:
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchship_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchship_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
