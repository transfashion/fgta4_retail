...
/**
 * retail/merch/merchship/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header merchship (trn_merchship)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['trn_merchshiporderout', 'trn_merchshipbudget', 'trn_merchrv', 'trn_merchbillin', 'trn_merchship', 'trn_merchship', 'trn_merchship', 'trn_merchship', 'trn_merchship'];
