...
/**
 * retail/merch/merchship/apis/realisasi-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel realisasi merchship (trn_merchbillin)
...
$API = new class extends merchshipBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new merchship_realisasiHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
