...
if (is_file(__DIR__ .'/data-billin-handler.php')) {
	require_once __DIR__ .'/data-billin-handler.php';
}
...
/**
 * retail/merch/merchship/apis/billin-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel billin merchship (trn_merchbillin)
 *
...
$API = new class extends merchshipBase {
	...
	public function execute($data, $options) {
		...
		$handlerclassname = "\\FGTA4\\apis\\merchship_billinHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchship_billinHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
