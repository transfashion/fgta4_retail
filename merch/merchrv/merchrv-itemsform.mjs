...
import * as hnd from  './merchrv-itemsform-hnd.mjs'
...
const obj = {
	txt_merchrvitem_id: $('#pnl_edititemsform-txt_merchrvitem_id'),
	...
	txt_merchrvitem_valuepo: $('#pnl_edititemsform-txt_merchrvitem_valuepo'),
	txt_merchrvitem_value: $('#pnl_edititemsform-txt_merchrvitem_value'),
	txt_merchrvitem_qtyinit: $('#pnl_edititemsform-txt_merchrvitem_qtyinit'),
	txt_merchrvitem_qty: $('#pnl_edititemsform-txt_merchrvitem_qty'),
	txt_merchrvitem_rate: $('#pnl_edititemsform-txt_merchrvitem_rate'),
	txt_merchrvitem_subtotalvaluefrg: $('#pnl_edititemsform-txt_merchrvitem_subtotalvaluefrg'),
	txt_merchrvitem_subtotalvalueidr: $('#pnl_edititemsform-txt_merchrvitem_subtotalvalueidr'),
	txt_merchrvitem_budgetaddcostidr: $('#pnl_edititemsform-txt_merchrvitem_budgetaddcostidr'),
	...
	txt_merchrvitem_actualaddcostidr: $('#pnl_edititemsform-txt_merchrvitem_actualaddcostidr'),
	txt_merchrvitem_actuallandedcostidr: $('#pnl_edititemsform-txt_merchrvitem_actuallandedcostidr'),
	txt_merchrv_id: $('#pnl_edititemsform-txt_merchrv_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchrvitem_id,
		autoid: true,
		logview: 'trn_merchrvitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.merchrv_descr)
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.merchrv_id = hdata.merchrv_id
		data.items_value = 0

		data.merchrvitem_valuepo = 0
		data.merchrvitem_value = 0
		data.merchrvitem_qtyinit = 0
		data.merchrvitem_qty = 0
		data.merchrvitem_rate = 0
		data.merchrvitem_subtotalvaluefrg = 0
		data.merchrvitem_subtotalvalueidr = 0
		data.merchrvitem_budgetaddcostidr = 0
		...
		data.merchrvitem_actualaddcostidr = 0
		data.merchrvitem_actuallandedcostidr = 0
...
function form_idsetup(options) {
	var objid = obj.txt_merchrvitem_id
