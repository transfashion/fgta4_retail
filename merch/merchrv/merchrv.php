...
if (is_file(__DIR__ .'/merchrv.php-handler.php')) {
	require_once __DIR__ .'/merchrv.php-handler.php';
}

/**
 * retail/merch/merchrv/merchrv.php
 *
 * ===================================================================
 * Entry point Program Module merchrv
 * ===================================================================
 ...
 * terakhir di generate tanggal 18/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchrv_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchrv_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
