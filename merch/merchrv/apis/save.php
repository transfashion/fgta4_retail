...
/**
 * retail/merch/merchrv/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends merchrvBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->merchrv_ref=='') { $obj->merchrv_ref = '--NULL--'; }
			if ($obj->merchrv_descr=='') { $obj->merchrv_descr = '--NULL--'; }


			unset($obj->merchrv_iscommit);
			unset($obj->merchrv_commitby);
			unset($obj->merchrv_commitdate);
			unset($obj->merchrv_ispost);
			unset($obj->merchrv_postby);
			unset($obj->merchrv_postdate);
