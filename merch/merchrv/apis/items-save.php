	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					...
					'merchrvitem_budgetlandedcostidr', 'merchrvitem_budgetmarkupidr', 'merchrvitem_budgetbillidr', 'merchrvitem_budgetbillppn',
					'merchrvitem_budgetbilldpp', 'merchrvitem_actualvaluefrg', 'merchrvitem_actualrate', 'merchrvitem_actualvalueidr',
					'merchrvitem_actualaddcostidr', 'merchrvitem_actuallandedcostidr', 'merchrv_id'
			];
