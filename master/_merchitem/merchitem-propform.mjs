...
const obj = {
	txt_merchitemprop_id: $('#pnl_editpropform-txt_merchitemprop_id'),
	cbo_merchproptype_id: $('#pnl_editpropform-cbo_merchproptype_id'),
	txt_merchitemprop_value: $('#pnl_editpropform-txt_merchitemprop_value'),
	txt_merchitem_id: $('#pnl_editpropform-txt_merchitem_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemprop_id,
		autoid: true,
		logview: 'mst_merchitemprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_merchproptype_id.name = 'pnl_editpropform-cbo_merchproptype_id'		
	new fgta4slideselect(obj.cbo_merchproptype_id, {
		title: 'Pilih merchproptype_id',
		returnpage: this_page_id,
		api: $ui.apis.load_merchproptype_id,
		fieldValue: 'merchproptype_id',
		fieldValueMap: 'merchproptype_id',
		fieldDisplay: 'merchproptype_name',
		fields: [
			{mapping: 'merchproptype_id', text: 'merchproptype_id'},
			{mapping: 'merchproptype_name', text: 'merchproptype_name'},
		],
		OnDataLoading: (criteria, options) => {
				
			if (typeof hnd!=='undefined') { 
				if (typeof hnd.cbo_merchproptype_id_dataloading === 'function') {
					hnd.cbo_merchproptype_id_dataloading(criteria, options);
				}
			}
		},
		OnDataLoaded : (result, options) => {
			...
			if (typeof hnd!=='undefined') { 
				if (typeof hnd.cbo_merchproptype_id_dataloaded === 'function') {
					hnd.cbo_merchproptype_id_dataloaded(result, options);
				}
			}
		},
		OnSelected: (value, display, record, args) => {
			if (value!=args.PreviousValue ) {
				if (typeof hnd!=='undefined') {  
					if (typeof hnd.cbo_merchproptype_id_selected === 'function') {
						hnd.cbo_merchproptype_id_selected(value, display, record, args);
					}
				}
			}			
		}
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_merchproptype_id, record.merchproptype_id, record.merchproptype_name)
			.setViewMode()
			.rowid = rowid
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchproptype_id = '0'
		data.merchproptype_name = '-- PILIH --'
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemprop_id
