...
const obj = {
	txt_merchitemref_id: $('#pnl_editrefform-txt_merchitemref_id'),
	cbo_interface_id: $('#pnl_editrefform-cbo_interface_id'),
	txt_merchitemref_code: $('#pnl_editrefform-txt_merchitemref_code'),
	txt_merchitem_id: $('#pnl_editrefform-txt_merchitem_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemref_id,
		autoid: true,
		logview: 'mst_merchitemref',
		btn_edit: btn_edit,
		btn_save: btn_save,
		...
		OnDataLoading: (criteria, options) => {
			...
			if (typeof hnd!=='undefined') { 
				if (typeof hnd.cbo_interface_id_dataloading === 'function') {
					hnd.cbo_interface_id_dataloading(criteria, options);
				}
			}
		},
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemref_id
