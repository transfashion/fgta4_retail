...
/**
 * retail/master/merchitem/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header merchitem (mst_merchitem)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_merchitembarcode', 'mst_merchitemprop', 'mst_merchitemretailchannel', 'mst_merchitemrelated', 'mst_merchitempic', 'mst_merchitemref'];
