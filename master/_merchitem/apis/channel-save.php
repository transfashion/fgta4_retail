...
/**
 * retail/master/merchitem/apis/channel-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchitemretailchannel_id', 'retailchannel_id', 'merchitem_isnonactive', 'merchitem_price', 'merchitem_isdiscvalue', 'merchitem_disc', 'merchitem_discval', 'merchitem_pricenett', 'merchitem_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
