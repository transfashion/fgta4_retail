...
$API = new class extends merchitemBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from mst_merchitem A" . $where->sql);
			...
			$stmt = $this->db->prepare("
				select 
				A.merchitem_id, A.merchitem_art, A.merchitem_mat, A.merchitem_col, A.merchitem_size, A.merchitem_name, A.merchitem_descr, A.merchitem_picture, A.merchitemctg_id, A.merchsea_id, A.brand_id, A.merchitem_width, A.merchitem_length, A.merchitem_height, A.merchitem_weight, A.merchitem_priceori, A.merchitem_price, A.merchitem_issp, A.merchitem_isdiscvalue, A.merchitem_disc, A.merchitem_discval, A.merchitem_pricenett, A.merchitem_lastcogs, A.merchitem_lastcogsdt, A.merchrpt_id, A.gender_id, A.merchitem_colorcode, A.merchitem_colorname, A.merchitem_hscodeship, A.merchitem_hscode, A.merchitemvar_id, A.merchsizetag_id, A.merchitem_isallchannel, A.merchitem_isnonactive, A.merchitem_isdisabled, A._createby, A._createdate, A._modifyby, A._modifydate 
				from mst_merchitem A
			" . $where->sql . $limit);
			$stmt->execute($where->params);
