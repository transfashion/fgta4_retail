...
/**
 * retail/master/merchitem/apis/picture-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchitempic_id', 'merchitempic_name', 'merchitempic_descr', 'merchitempic_order', 'merchitempic_file', 'merchitem_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
