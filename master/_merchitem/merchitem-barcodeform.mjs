...
const obj = {
	txt_merchitembarcode_id: $('#pnl_editbarcodeform-txt_merchitembarcode_id'),
	txt_merchitembarcode_text: $('#pnl_editbarcodeform-txt_merchitembarcode_text'),
	txt_brand_id: $('#pnl_editbarcodeform-txt_brand_id'),
	txt_merchitem_id: $('#pnl_editbarcodeform-txt_merchitem_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitembarcode_id,
		autoid: true,
		logview: 'mst_merchitembarcode',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_merchitembarcode_id
