...
if (is_file(__DIR__ .'/merchregtype.php-handler.php')) {
	require_once __DIR__ .'/merchregtype.php-handler.php';
}

/**
 * retail/master/merchregtype/merchregtype.php
 *
 * ===================================================================
 * Entry point Program Module merchregtype
 * ===================================================================
 ...
 * awal dibuat tanggal 13/07/2023
 * terakhir di generate tanggal 13/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchregtype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchregtype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
