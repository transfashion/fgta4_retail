...
/**
 * retail/master/merchregtype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchregtype (mst_merchregtype)
...
$API = new class extends merchregtypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.merchregtype_id LIKE CONCAT('%', :search, '%') OR A.merchregtype_name LIKE CONCAT('%', :search, '%') "
			];
