...
import * as hnd from  './merchregtype-edit-hnd.mjs'
...
const obj = {
	txt_merchregtype_id: $('#pnl_edit-txt_merchregtype_id'),
	txt_merchregtype_name: $('#pnl_edit-txt_merchregtype_name'),
	chk_merchregtype_iscangenerate: $('#pnl_edit-chk_merchregtype_iscangenerate'),
	txt_merchregtype_descr: $('#pnl_edit-txt_merchregtype_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchregtype_id,
		autoid: false,
		logview: 'mst_merchregtype',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.merchregtype_iscangenerate = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_merchregtype_id
