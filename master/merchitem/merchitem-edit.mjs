...
const obj = {
	...
	txt_merchregitem_id: $('#pnl_edit-txt_merchregitem_id'),
	chk_merchitem_isupdating: $('#pnl_edit-chk_merchitem_isupdating'),
	txt_merchitem_updatebatch: $('#pnl_edit-txt_merchitem_updatebatch'),
