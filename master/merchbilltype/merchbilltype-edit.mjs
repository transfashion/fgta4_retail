...
import * as hnd from  './merchbilltype-edit-hnd.mjs'
...
const obj = {
	txt_merchbilltype_id: $('#pnl_edit-txt_merchbilltype_id'),
	txt_merchbilltype_name: $('#pnl_edit-txt_merchbilltype_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchbilltype_id,
		autoid: false,
		logview: 'mst_merchbilltype',
...
function form_idsetup(options) {
	var objid = obj.txt_merchbilltype_id
