...
if (is_file(__DIR__ .'/merchbilltype.php-handler.php')) {
	require_once __DIR__ .'/merchbilltype.php-handler.php';
}

/**
 * retail/master/merchbilltype/merchbilltype.php
 *
 * ===================================================================
 * Entry point Program Module merchbilltype
 * ===================================================================
 ...
 * awal dibuat tanggal 31/07/2023
 * terakhir di generate tanggal 31/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchbilltype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchbilltype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
