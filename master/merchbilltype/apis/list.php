...
/**
 * retail/master/merchbilltype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchbilltype (mst_merchbilltype)
...
$API = new class extends merchbilltypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.merchbilltype_id LIKE CONCAT('%', :search, '%') "
			];
