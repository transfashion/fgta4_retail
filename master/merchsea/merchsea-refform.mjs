...
import * as hnd from  './merchsea-refform-hnd.mjs'
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchsearef_id,
		autoid: true,
		logview: 'mst_merchsearef',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.merchsea_name)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.merchsea_id= hdata.merchsea_id
		data.ref_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_merchsearef_id
