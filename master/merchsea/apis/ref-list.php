...
/**
 * retail/master/merchsea/apis/ref-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel ref merchsea (mst_merchsea)
...
$API = new class extends merchseaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from mst_merchsearef A" . $where->sql);
			...
			$stmt = $this->db->prepare("
				select 
				A.merchsearef_id, A.interface_id, A.merchsearef_code, A.merchsea_id, A._createby, A._createdate, A._modifyby, A._modifydate 
				from mst_merchsearef A
			" . $where->sql . $limit);
			$stmt->execute($where->params);
