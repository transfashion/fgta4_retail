...
/**
 * retail/master/merchsea/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchsea (mst_merchsea)
...
$API = new class extends merchseaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from mst_merchsea A" . $where->sql);
			...
			$stmt = $this->db->prepare("
				select 
				A.merchsea_id, A.merchsea_name, A.merchsea_namedisplay, A.merchsea_year, A.merchsea_yearmaxvisible, A.merchsea_isdisabled, A.merchsea_datestart, A.merchsea_dateend, A.merchseagroup_id, A._createby, A._createdate, A._modifyby, A._modifydate 
				from mst_merchsea A
