...
/**
 * retail/master/merchsea/apis/ref-save.php
 *
 * ==========
 * Detil-Save
 * ==========
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_merchsea';
				$header_primarykey = 'merchsea_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchsearef_id', 'interface_id', 'merchsearef_code', 'merchsea_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
