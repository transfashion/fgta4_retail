...
/**
 * retail/master/merchitemgro/apis/picture-save.php
 *
 * ==========
 * Detil-Save
 * ==========
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_merchitemgro';
				$header_primarykey = 'merchitemgro_id';
				...
				$fieldname = 'merchitemgropic_file';	
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchitemgropic_id', 'merchitemgropic_name', 'merchitemgropic_descr', 'merchitemgropic_order', 'merchitemgropic_file', 'merchsea_id', 'merchitemgro_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
