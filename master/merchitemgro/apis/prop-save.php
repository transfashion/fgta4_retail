...
/**
 * retail/master/merchitemgro/apis/prop-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'merchitemgroprop_id', 'merchproptype_id', 'merchitemcatprop_value', 'merchitemgro_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
