...
/**
 * retail/master/merchitemgro/apis/xapi.base.php
 *
 * merchitemgroBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul merchitemgro
 *
 ...
 * tanggal 09/06/2022
 */
class merchitemgroBase extends WebAPI {

	protected $main_tablename = "mst_merchitemgro";
	protected $main_primarykey = "merchitemgro_id";
	protected $main_field_version = "merchitemgro_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*merchitemgro*/.txt";
		// debug::disable();
