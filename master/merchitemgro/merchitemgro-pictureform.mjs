...
const fl_merchitemgropic_file_img = $('#pnl_editpictureform-fl_merchitemgropic_file_img');
const fl_merchitemgropic_file_lnk = $('#pnl_editpictureform-fl_merchitemgropic_file_link');				
			

const pnl_form = $('#pnl_editpictureform-form')
const obj = {
	txt_merchitemgropic_id: $('#pnl_editpictureform-txt_merchitemgropic_id'),
	txt_merchitemgropic_name: $('#pnl_editpictureform-txt_merchitemgropic_name'),
	txt_merchitemgropic_descr: $('#pnl_editpictureform-txt_merchitemgropic_descr'),
	txt_merchitemgropic_order: $('#pnl_editpictureform-txt_merchitemgropic_order'),
	fl_merchitemgropic_file: $('#pnl_editpictureform-fl_merchitemgropic_file'),
	cbo_merchsea_id: $('#pnl_editpictureform-cbo_merchsea_id'),
	txt_merchitemgro_id: $('#pnl_editpictureform-txt_merchitemgro_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemgropic_id,
		autoid: true,
		logview: 'mst_merchitemgropic',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.fl_merchitemgropic_file.filebox({
		onChange: function(value) {
			var files = obj.fl_merchitemgropic_file.filebox('files');
			var f = files[0];
				...
				return function(e) {
					if (loaded.type.startsWith('image')) {
						...
						image.onload = function() {
							fl_merchitemgropic_file_img.attr('src', e.target.result);
							fl_merchitemgropic_file_img.show();
							fl_merchitemgropic_file_lnk.hide();
						}
					} else {
						fl_merchitemgropic_file_img.hide();
						fl_merchitemgropic_file_lnk.hide();
					}
				}
			})(f);
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.merchitemgro_id= hdata.merchitemgro_id
		data.picture_value = 0

		data.merchitemgropic_order = 0
		...
		fl_merchitemgropic_file_img.hide();
		fl_merchitemgropic_file_lnk.hide();	
		obj.fl_merchitemgropic_file.filebox('clear');		
...
function updatefilebox(record) {
	...
	obj.fl_merchitemgropic_file.filebox('clear');			
	if (record.merchitemgropic_file_doc!=undefined) {
		if (record.merchitemgropic_file_doc.type.startsWith('image')) {
			fl_merchitemgropic_file_lnk.hide();
			fl_merchitemgropic_file_img.show();
			fl_merchitemgropic_file_img.attr('src', record.merchitemgropic_file_doc.attachmentdata);
		} else {
			fl_merchitemgropic_file_img.hide();
			fl_merchitemgropic_file_lnk.show();
			fl_merchitemgropic_file_lnk[0].onclick = () => {
				fl_merchitemgropic_file_lnk.attr('download', record.merchitemgropic_file_doc.name);
				fl_merchitemgropic_file_lnk.attr('href', record.merchitemgropic_file_doc.attachmentdata);
			}
		}	
	} else {
		fl_merchitemgropic_file_img.hide();
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemgropic_id
