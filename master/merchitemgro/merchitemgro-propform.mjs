...
const obj = {
	txt_merchitemgroprop_id: $('#pnl_editpropform-txt_merchitemgroprop_id'),
	...
	txt_merchitemgro_id: $('#pnl_editpropform-txt_merchitemgro_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemgroprop_id,
		autoid: true,
		logview: 'mst_merchitemgroprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_merchproptype_id, record.merchproptype_id, record.webproptype_name)
			.setViewMode()
			.rowid = rowid
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemgroprop_id
