...
/**
 * retail/master/merchshipbudgetacc/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchshipbudgetacc (mst_merchshipbudgetacc)
...
$API = new class extends merchshipbudgetaccBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.merchshipbudgetacc_id LIKE CONCAT('%', :search, '%') "
			];
