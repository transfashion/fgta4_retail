...
if (is_file(__DIR__ .'/merchshipbudgetacc.php-handler.php')) {
	require_once __DIR__ .'/merchshipbudgetacc.php-handler.php';
}

/**
 * retail/master/merchshipbudgetacc/merchshipbudgetacc.php
 *
 * ===================================================================
 * Entry point Program Module merchshipbudgetacc
 * ===================================================================
 ...
 * awal dibuat tanggal 29/07/2023
 * terakhir di generate tanggal 13/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchshipbudgetacc_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchshipbudgetacc_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
