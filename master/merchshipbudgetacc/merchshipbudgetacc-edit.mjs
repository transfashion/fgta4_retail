...
import * as hnd from  './merchshipbudgetacc-edit-hnd.mjs'
...
const obj = {
	txt_merchshipbudgetacc_id: $('#pnl_edit-txt_merchshipbudgetacc_id'),
	txt_merchshipbudgetacc_name: $('#pnl_edit-txt_merchshipbudgetacc_name'),
	txt_merchshipbudgetacc_group: $('#pnl_edit-txt_merchshipbudgetacc_group'),
	chk_merchshipbudgetacc_isexclude: $('#pnl_edit-chk_merchshipbudgetacc_isexclude'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchshipbudgetacc_id,
		autoid: false,
		logview: 'mst_merchshipbudgetacc',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchshipbudgetacc_isexclude = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_merchshipbudgetacc_id
