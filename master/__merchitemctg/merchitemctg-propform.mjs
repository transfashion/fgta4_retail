...
import * as hnd from  './merchitemctg-propform-hnd.mjs'
...
const obj = {
	txt_merchitemctgprop_id: $('#pnl_editpropform-txt_merchitemctgprop_id'),
	cbo_merchproptype_id: $('#pnl_editpropform-cbo_merchproptype_id'),
	txt_merchitemctgprop_value: $('#pnl_editpropform-txt_merchitemctgprop_value'),
	txt_merchitemctg_id: $('#pnl_editpropform-txt_merchitemctg_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemctgprop_id,
		autoid: true,
		logview: 'mst_merchitemctgprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemctgprop_id
