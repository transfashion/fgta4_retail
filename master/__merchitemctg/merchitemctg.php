...
if (is_file(__DIR__ .'/merchitemctg.php-handler.php')) {
	require_once __DIR__ .'/merchitemctg.php-handler.php';
}

/**
 * retail/master/merchitemctg/merchitemctg.php
 *
 * ===================================================================
 * Entry point Program Module merchitemctg
 * ===================================================================
 ...
 * awal dibuat tanggal 08/07/2023
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchitemctg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchitemctg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
