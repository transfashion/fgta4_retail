...
/**
 * retail/master/merchitemctg/apis/ref-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel ref merchitemctg (mst_merchitemctgref)
...
$API = new class extends merchitemctgBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new merchitemctg_refHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
