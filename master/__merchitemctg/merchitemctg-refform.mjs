...
import * as hnd from  './merchitemctg-refform-hnd.mjs'
...
const obj = {
	txt_merchitemctgref_id: $('#pnl_editrefform-txt_merchitemctgref_id'),
	cbo_brand_id: $('#pnl_editrefform-cbo_brand_id'),
	cbo_interface_id: $('#pnl_editrefform-cbo_interface_id'),
	txt_merchitemctgref_code: $('#pnl_editrefform-txt_merchitemctgref_code'),
	txt_merchitemctgref_value: $('#pnl_editrefform-txt_merchitemctgref_value'),
	txt_merchitemctg_id: $('#pnl_editrefform-txt_merchitemctg_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchitemctgref_id,
		autoid: true,
		logview: 'mst_merchitemctgref',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_brand_id.name = 'pnl_editrefform-cbo_brand_id'		
...
function form_idsetup(options) {
	var objid = obj.txt_merchitemctgref_id
