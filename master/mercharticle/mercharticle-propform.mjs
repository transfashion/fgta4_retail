...
import * as hnd from  './mercharticle-propform-hnd.mjs'
...
const obj = {
	txt_mercharticleprop_id: $('#pnl_editpropform-txt_mercharticleprop_id'),
	cbo_itemproptype_id: $('#pnl_editpropform-cbo_itemproptype_id'),
	txt_mercharticleprop_keys: $('#pnl_editpropform-txt_mercharticleprop_keys'),
	txt_mercharticleprop_value: $('#pnl_editpropform-txt_mercharticleprop_value'),
	txt_mercharticle_id: $('#pnl_editpropform-txt_mercharticle_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_mercharticleprop_id,
		autoid: true,
		logview: 'mst_mercharticleprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_mercharticleprop_id
