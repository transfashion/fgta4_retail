...
/**
 * retail/master/mercharticle/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header mercharticle (mst_mercharticle)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_mercharticleprop', 'mst_merchitem', 'mst_merchpic'];
