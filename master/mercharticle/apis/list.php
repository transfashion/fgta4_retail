...
/**
 * retail/master/mercharticle/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header mercharticle (mst_mercharticle)
...
$API = new class extends mercharticleBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.mercharticle_id LIKE CONCAT('%', :search, '%') OR A.mercharticle_art LIKE CONCAT('%', :search, '%') "
			];
