...
import * as hnd from  './mercharticle-pictureform-hnd.mjs'
...
const fl_merchpic_file_img = $('#pnl_editpictureform-fl_merchpic_file_img');
const fl_merchpic_file_lnk = $('#pnl_editpictureform-fl_merchpic_file_link');				
			

const pnl_form = $('#pnl_editpictureform-form')
const obj = {
	txt_merchpic_id: $('#pnl_editpictureform-txt_merchpic_id'),
	txt_merchpic_couchdbid: $('#pnl_editpictureform-txt_merchpic_couchdbid'),
	txt_merchpic_col: $('#pnl_editpictureform-txt_merchpic_col'),
	txt_merchpic_name: $('#pnl_editpictureform-txt_merchpic_name'),
	txt_merchpic_descr: $('#pnl_editpictureform-txt_merchpic_descr'),
	txt_merchpic_order: $('#pnl_editpictureform-txt_merchpic_order'),
	fl_merchpic_file: $('#pnl_editpictureform-fl_merchpic_file'),
	txt_mercharticle_id: $('#pnl_editpictureform-txt_mercharticle_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchpic_id,
		autoid: true,
		logview: 'mst_merchpic',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.fl_merchpic_file.filebox({
		onChange: function(value) {
			var files = obj.fl_merchpic_file.filebox('files');
			var f = files[0];
				...
				return function(e) {
					if (loaded.type.startsWith('image')) {
						...
						image.onload = function() {
							fl_merchpic_file_img.attr('src', e.target.result);
							fl_merchpic_file_img.show();
							fl_merchpic_file_lnk.hide();
						}
					} else {
						fl_merchpic_file_img.hide();
						fl_merchpic_file_lnk.hide();
					}
				}
			})(f);
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		fl_merchpic_file_img.hide();
		fl_merchpic_file_lnk.hide();	
		obj.fl_merchpic_file.filebox('clear');		
...
function updatefilebox(record) {
	...
	obj.fl_merchpic_file.filebox('clear');			
	if (record.merchpic_file_doc!=undefined) {
		if (record.merchpic_file_doc.type.startsWith('image')) {
			fl_merchpic_file_lnk.hide();
			fl_merchpic_file_img.show();
			fl_merchpic_file_img.attr('src', record.merchpic_file_doc.attachmentdata);
		} else {
			fl_merchpic_file_img.hide();
			fl_merchpic_file_lnk.show();
			fl_merchpic_file_lnk[0].onclick = () => {
				fl_merchpic_file_lnk.attr('download', record.merchpic_file_doc.name);
				fl_merchpic_file_lnk.attr('href', record.merchpic_file_doc.attachmentdata);
			}
		}	
	} else {
		fl_merchpic_file_img.hide();
