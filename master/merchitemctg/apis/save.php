...
/**
 * retail/master/merchitemctg/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends merchitemctgBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->merchitemctg_id = strtoupper($obj->merchitemctg_id);
			$obj->merchitemctg_name = strtoupper($obj->merchitemctg_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"merchitemctg_id" => $obj->merchitemctg_id
				];
