...
/**
 * retail/master/merchitemctg/apis/prop-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel prop merchitemctg (mst_merchitemctgprop)
...
$API = new class extends merchitemctgBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new merchitemctg_propHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('merchproptype_name', 'merchproptype_id', $record, 'mst_merchproptype', 'merchproptype_name', 'merchproptype_id');
