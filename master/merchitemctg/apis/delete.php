...
/**
 * retail/master/merchitemctg/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header merchitemctg (mst_merchitemctg)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_merchitemctgpic', 'mst_merchitemctgprop', 'mst_merchitemctgref'];
