...
import * as hnd from  './merchseagroup-edit-hnd.mjs'
...
const obj = {
	txt_merchseagroup_id: $('#pnl_edit-txt_merchseagroup_id'),
	txt_merchseagroup_name: $('#pnl_edit-txt_merchseagroup_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchseagroup_id,
		autoid: false,
		logview: 'mst_merchseagroup',
...
function form_idsetup(options) {
	var objid = obj.txt_merchseagroup_id
