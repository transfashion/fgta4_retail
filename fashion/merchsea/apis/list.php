...
/**
 * retail/fashion/merchsea/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header merchsea (fsn_merchsea)
...
$API = new class extends merchseaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.merchsea_id LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('merchseagroup_name', 'merchseagroup_id', $record, 'fsn_merchseagroup', 'merchseagroup_name', 'merchseagroup_id');
