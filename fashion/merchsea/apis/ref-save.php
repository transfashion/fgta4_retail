...
/**
 * retail/fashion/merchsea/apis/ref-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel ref merchsea (fsn_merchsearef)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'fsn_merchsea';
				$header_primarykey = 'merchsea_id';
				$detil_primarykey = 'merchsea_id';
				...
				// result
				$options->criteria = [
					"merchsearef_id" => $obj->merchsearef_id
				];
