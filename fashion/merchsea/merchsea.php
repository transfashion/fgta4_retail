...
if (is_file(__DIR__ .'/merchsea.php-handler.php')) {
	require_once __DIR__ .'/merchsea.php-handler.php';
}

/**
 * retail/fashion/merchsea/merchsea.php
 *
 * ===================================================================
 * Entry point Program Module merchsea
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchsea_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchsea_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
