...
import * as hnd from  './merchreg-edit-hnd.mjs'
...
const obj = {
	txt_merchreg_id: $('#pnl_edit-txt_merchreg_id'),
	dt_merchreg_date: $('#pnl_edit-dt_merchreg_date'),
	txt_merchreg_descr: $('#pnl_edit-txt_merchreg_descr'),
	...
	txt_merchreg_version: $('#pnl_edit-txt_merchreg_version'),
	chk_merchreg_iscommit: $('#pnl_edit-chk_merchreg_iscommit'),
	txt_merchreg_commitby: $('#pnl_edit-txt_merchreg_commitby'),
	txt_merchreg_commitdate: $('#pnl_edit-txt_merchreg_commitdate'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchreg_id,
		autoid: true,
		logview: 'fsn_merchreg',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.merchreg_date = global.now()
		data.curr_rate = 0
		data.merchreg_version = 0
		data.merchreg_iscommit = '0'
		data.merchreg_isgenerate = '0'
		data.merchreg_isinsynprogress = '0'
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.merchreg_commitby);
	rec_commitdate.html(record.merchreg_commitdate);
...
function updategridstate(record) {
	...
	var col_commit = 'merchreg_iscommit';
	updategriddata[col_commit] = record.merchreg_iscommit;	
...
async function btn_action_click(args) {
	...
	var docname = 'Merchandise Register'
	var txt_version = obj.txt_merchreg_version;
	var chk_iscommit = obj.chk_merchreg_iscommit;
