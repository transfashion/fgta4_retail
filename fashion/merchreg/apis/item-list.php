...
/**
 * retail/fashion/merchreg/apis/item-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel item merchreg (fsn_merchregitem)
			...
			foreach ($rows as $row) {
				...
				$record = array_merge($record, [
					...
					//'tanggal' => date("d/m/y", strtotime($record['tanggal'])),
				 	//'tambahan' => 'dta'
					'merchitemctg_name' => \FGTA4\utils\SqlUtility::Lookup($record['merchitemctg_id'], $this->db, 'fsn_merchitemctg', 'merchitemctg_id', 'merchitemctg_name'),
				...
				*/
				...
				$this->addFields('merchitemctg_name', 'merchitemctg_id', $record, 'fsn_merchitemctg', 'merchitemctg_name', 'merchitemctg_id');
