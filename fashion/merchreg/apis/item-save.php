...
/**
 * retail/fashion/merchreg/apis/item-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends merchregBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sqlUpdateField  = [
					'merchregitem_id', 'merchitem_refitem', 'merchitem_barcode', 'merchitem_art',
					'merchitem_mat', 'merchitem_col', 'merchitem_size', 'merchitem_combo',
					'merchitem_name', 'merchitem_descr', 'merchitem_colnum', 'merchitem_isdisabled',
					'merchitem_pcpline', 'merchitem_pcpgroup', 'merchitem_pcpcategory', 'merchitem_colorcode',
					'merchitem_colordescr', 'merchitem_gender', 'merchitem_fit', 'merchitem_hscodeship',
					'merchitem_hscodeina', 'merchitem_gtype', 'merchitem_labelname', 'merchitem_labelproduct',
					'merchitem_bahan', 'merchitem_pemeliharaan', 'merchitem_logo', 'merchitem_dibuatdi',
					'merchitem_width', 'merchitem_length', 'merchitem_height', 'merchitem_weight',
					'merchitem_fob', 'merchitem_initqty', 'merchitemctg_id', 'unit_id',
					'dept_id', 'merchreg_id'
			];
