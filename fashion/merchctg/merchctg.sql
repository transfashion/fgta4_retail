...
ALTER TABLE `fsn_merchctg` ADD COLUMN IF NOT EXISTS  `unit_id` varchar(10) NOT NULL  AFTER `itemgroup_id`;
...
ALTER TABLE `fsn_merchctg` MODIFY COLUMN IF EXISTS  `unit_id` varchar(10) NOT NULL   AFTER `itemgroup_id`;
