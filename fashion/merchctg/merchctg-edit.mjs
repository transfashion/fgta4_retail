...
import * as hnd from  './merchctg-edit-hnd.mjs'
...
const obj = {
	...
	txt_merchctg_name: $('#pnl_edit-txt_merchctg_name'),
	txt_merchctg_nameshort: $('#pnl_edit-txt_merchctg_nameshort'),
	txt_merchctg_descr: $('#pnl_edit-txt_merchctg_descr'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchctg_id,
		autoid: false,
		logview: 'fsn_merchctg',
