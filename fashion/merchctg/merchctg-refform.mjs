...
import * as hnd from  './merchctg-refform-hnd.mjs'
...
const obj = {
	txt_merchctgref_id: $('#pnl_editrefform-txt_merchctgref_id'),
	cbo_interface_id: $('#pnl_editrefform-cbo_interface_id'),
	txt_merchctgref_name: $('#pnl_editrefform-txt_merchctgref_name'),
	txt_merchctgref_code: $('#pnl_editrefform-txt_merchctgref_code'),
	txt_merchctgref_otherdata: $('#pnl_editrefform-txt_merchctgref_otherdata'),
	txt_merchctgref_notes: $('#pnl_editrefform-txt_merchctgref_notes'),
	txt_merchctg_id: $('#pnl_editrefform-txt_merchctg_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchctgref_id,
		autoid: true,
		logview: 'fsn_merchctgref',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.merchctg_name)
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.merchctg_id = hdata.merchctg_id
		data.ref_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_merchctgref_id
