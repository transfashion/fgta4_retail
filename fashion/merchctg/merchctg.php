...
if (is_file(__DIR__ .'/merchctg.php-handler.php')) {
	require_once __DIR__ .'/merchctg.php-handler.php';
}

/**
 * retail/fashion/merchctg/merchctg.php
 *
 * ===================================================================
 * Entry point Program Module merchctg
 * ===================================================================
 ...
 * awal dibuat tanggal 06/09/2024
 * terakhir di generate tanggal 18/10/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchctg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchctg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
