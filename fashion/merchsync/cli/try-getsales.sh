...
# contoh eksekusi
# ./try-getsales.sh -c "/var/www/html/cli"


clear

input_var_n="--name getsales"  # name longtask
input_var_p="--pid getsales"  # pid longtask
...
input_var_l="--log \"/mnt/ramdisk/log-getsales.txt\""  # file log
...
command="php $clipath retail/fashion/merchsync/try-getsales $opt"
