...
input_var_n="--name getregister"  # name longtask
input_var_p="--pid 123456789"  # pid longtask
...
input_var_l="--log \"/mnt/ramdisk/log-merchsync.txt\""  # file log
...
command="php $clipath retail/fashion/merchsync/sync $opt"
