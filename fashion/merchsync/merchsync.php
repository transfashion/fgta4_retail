...
if (is_file(__DIR__ .'/merchsync.php-handler.php')) {
	require_once __DIR__ .'/merchsync.php-handler.php';
}

/**
 * retail/fashion/merchsync/merchsync.php
 *
 * ===================================================================
 * Entry point Program Module merchsync
 * ===================================================================
 ...
 * awal dibuat tanggal 04/09/2024
 * terakhir di generate tanggal 04/09/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchsync_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchsync_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
