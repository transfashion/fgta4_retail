...
CREATE TABLE IF NOT EXISTS `fsn_merchsync` (
	...
	`merchsync_result` varchar(30) NOT NULL , 
...
ENGINE=MyISAM
COMMENT='Daftar Que Dokumen yang akan diSync';
...
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_result` varchar(30) NOT NULL  AFTER `merchsync_isfail`;
...
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_result` varchar(30) NOT NULL   AFTER `merchsync_isfail`;
