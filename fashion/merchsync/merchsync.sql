...
CREATE TABLE IF NOT EXISTS `fsn_merchsync` (
	...
	`merchsync_timeout` datetime  , 
	`merchsync_batch` varchar(30)  , 
	`merchsync_isfail` tinyint(1) NOT NULL DEFAULT 0, 
	`merchsync_iscompleted` tinyint(1) NOT NULL DEFAULT 0, 
...
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_timeout` datetime   AFTER `merchsync_isprocessing`;
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_batch` varchar(30)   AFTER `merchsync_timeout`;
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_isfail` tinyint(1) NOT NULL DEFAULT 0 AFTER `merchsync_batch`;
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_iscompleted` tinyint(1) NOT NULL DEFAULT 0 AFTER `merchsync_isfail`;
ALTER TABLE `fsn_merchsync` ADD COLUMN IF NOT EXISTS  `merchsync_result` varchar(255)   AFTER `merchsync_iscompleted`;
...
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_timeout` datetime    AFTER `merchsync_isprocessing`;
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_batch` varchar(30)    AFTER `merchsync_timeout`;
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_isfail` tinyint(1) NOT NULL DEFAULT 0  AFTER `merchsync_batch`;
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_iscompleted` tinyint(1) NOT NULL DEFAULT 0  AFTER `merchsync_isfail`;
ALTER TABLE `fsn_merchsync` MODIFY COLUMN IF EXISTS  `merchsync_result` varchar(255)    AFTER `merchsync_iscompleted`;
