...
import * as hnd from  './merchsync-edit-hnd.mjs'
...
const obj = {
	txt_merchsync_id: $('#pnl_edit-txt_merchsync_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_merchsync_id,
		autoid: false,
		logview: 'fsn_merchsync',
...
function form_idsetup(options) {
	var objid = obj.txt_merchsync_id
