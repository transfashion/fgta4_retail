...
if (is_file(__DIR__ .'/merchseagroup.php-handler.php')) {
	require_once __DIR__ .'/merchseagroup.php-handler.php';
}

/**
 * retail/fashion/merchseagroup/merchseagroup.php
 *
 * ===================================================================
 * Entry point Program Module merchseagroup
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\merchseagroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new merchseagroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
